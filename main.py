...
app = FastAPI(title='Mayson Generated APIs - awesome-aarohi-d01e2a4edb', debug=False,
              docs_url='/ap-northeast-1-backstractelb-74667a-coll-6dc75861c1a747fb9a7d12f9d2b7b6ed/docs',
              openapi_url='/ap-northeast-1-backstractelb-74667a-coll-6dc75861c1a747fb9a7d12f9d2b7b6ed/openapi.json',
              root_path='')
...
app.include_router(
    router,
    prefix='/ap-northeast-1-backstractelb-74667a-coll-6dc75861c1a747fb9a7d12f9d2b7b6ed/api',
    tags=['APIs v1']
)
